...
class Reactor {
    ...
    loadResources(resources) {
        return __awaiter(this, void 0, void 0, function* () {
            // Create the clean output folder.
            ...
            // Load the resources.
            for (const { packageName: name, saveAs } of resources) {
                yield this.loadResource(name, this._target, saveAs);
            }
        });
    }
     ...
     * @param target The optional target (e.g., es2022, esnext).
     * @param saveAs The optional save as string.
     */
    loadResource(name, target, saveAs) {
        return __awaiter(this, void 0, void 0, function* () {
            // Construct the URL for the resource and the save as path.
            const url = new URL(name + `?target=${target}`, 'https://esm.sh');
    ...
    loadDependency(level, dependency, saveAs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let url = new URL(dependency, 'https://esm.sh');
            const saveAsPath = path.join(this._outputFolder, saveAs);
            // Log what's happening.
...
//# sourceMappingURL=esmPackageLoader.js.map